...
class BeepSound(QMainWindow): # 반드시 QMainWindow를 파라미터로
    def __init__(self) : # 초기화 했을 때 제일 먼저 동작
        super().__init__()
        self.setWindowTitle('삑 소리 내기') 		# 윈도우 이름과 위치 지정
        self.setGeometry(200,200,500,100)       # 좌측 상단 기준으로 위치와 크기 (x,y,w,h)
        ...
        # 윈도우와 버튼, 라벨 연결
        shortBeepButton.setGeometry(10,10,100,30)	# 버튼 위치와 크기 지정, 윈도우의 좌측 상단 기준으로 10*10 위치에 100*30 크기로
